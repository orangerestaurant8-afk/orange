...
const schema = new Schema(
  {
    ...
    status: {
      type: String,
      enum: ['New', 'Preparing', 'Out for Delivery', 'Delivered', 'Cancelled'],
      default: 'New',
    },
    ...
    checkoutId: { type: String, unique: true, sparse: true, index: true },
    posOrderId: { type: String, index: true, sparse: true },
    integrationOrigin: { type: String, default: 'website' },
  },
  { timestamps: true },
);
export type Order = InferSchemaType<typeof schema>;
