...
const schema = new Schema({
  ...
  status: { type: String, enum: ['New', 'Preparing', 'Out for Delivery', 'Delivered', 'Cancelled'], default: 'New' }, deliveryAddress: { type: String, required: true }, deliveryArea: { type: String, required: true }, paymentMethod: { type: String, enum: ['Cash on Delivery', 'Credit/Debit Card'], required: true }, statusHistory: { type: [history], default: [] },
